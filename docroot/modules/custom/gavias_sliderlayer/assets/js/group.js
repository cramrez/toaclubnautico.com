...
! function(a) {
    ...
    function c() {
        ...
        a.ajax({
            ...
            dataType: "json",
            success: function(c) {
                a("#save").val("Save"), a.notify('Group Slider has been updated', 'success'), a("#save").removeAttr("disabled");
                //a("#save").val("Save"), b("success", "Slider Group setting updated"), a("#save").removeAttr("disabled")
            },
            error: function(c, d, e) {
               alert(d + ":" + c.responseText), a.notify("Group Slider can't update", 'error'), a("#save").removeAttr("disabled")
