 ...
 *
 * @param string $content Content to search for shortcodes.
 * @param bool $ignore_html When true, shortcodes inside HTML els will be skipped.
...
/**
 * Search only inside HTML els for shortcodes and process them.
 *
 * Any [ or ] characters remaining inside els will be HTML encoded
 * to prevent interference with shortcodes that are outside the els.
 ...
 *
 * @param string $content Content to search for shortcodes
 * @param bool $ignore_html When true, all square braces inside els will be encoded.
 * @return string Content with shortcodes filtered out.
 */
...
/**
 * Separate HTML els and comments from the text.
 *
 * @since 4.2.4
 *
