...
function gavias_kiamo_base_url(){
  global $base_url;
  $theme_path = \Drupal::service('extension.list.theme')->getPath('gavias_kiamo');
...
function gavias_kiamo_preprocess_node__portfolio(&$variables){
  $node = $variables['node'];
...
function gavias_kiamo_preprocess_breadcrumb(&$variables){
