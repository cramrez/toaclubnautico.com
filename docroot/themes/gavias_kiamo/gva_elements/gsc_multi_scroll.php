...
if(!class_exists('gsc_multi_scroll')):
   class gsc_multi_scroll{
      ...
      public static function sc_multi_scroll( $attr, $content = null ){
         ...
         <script src="<?php print \Drupal::service('extension.list.theme')->getPath('gavias_kiamo') ?>/vendor/multiscroll/jquery.easings.min.js"></script>
         <script src="<?php print \Drupal::service('extension.list.theme')->getPath('gavias_kiamo') ?>/vendor/multiscroll/jquery.multiscroll.min.js"></script>
         <link rel="stylesheet" href="<?php print \Drupal::service('extension.list.theme')->getPath('gavias_kiamo') ?>/vendor/multiscroll/jquery.multiscroll.min.css" media="screen" />
