   ...
   class gsc_chart{
      ...
      public static function sc_chart( $attr, $content = null ){
         ...
         <div class="widget gsc-chart <?php print $el_class ?>">
            <div class="pieChart" data-bar-color="<?php print $color ?>" data-bar-line-width="<?php print $line_width ?>" data-bar-width="150" data-percent="<?php print $percent ?>">
