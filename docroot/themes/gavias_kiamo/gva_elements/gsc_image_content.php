   ...
   class gsc_image_content{
      ...
      public static function sc_image_content( $attr, $content = null ){
         ...
         <div class="gsc-image-content <?php print $el_class; ?>">
            <div class="image"><?php if($link){ ?><a <?php print $target ?> href="<?php print $link ?>"><?php } ?><img src="<?php print $background ?>" alt="<?php print $title ?>" loading="lazy" /><?php if($link){ ?></a><?php } ?></div>
            <div class="content">
