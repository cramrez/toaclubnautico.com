...
if(!class_exists('gsc_gmap')):
   class gsc_gmap{
      ...
      <script type="text/javascript" src="//maps.googleapis.com/maps/api/js?key=<?php print $google_api ?>"></script>
      <script type="text/javascript" src="<?php print (base_path() . \Drupal::service('extension.list.theme')->getPath('gavias_kiamo')) ?>/vendor/gmap3.js"></script>
      <script type="text/javascript" src="<?php print (base_path() . \Drupal::service('extension.list.theme')->getPath('gavias_kiamo')) ?>/vendor/jquery.ui.map.min.js"></script>
